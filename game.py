...
class Game(QWidget):
    ...
    def nameInput(self):  # 게임이 시작되었을 때 다마고치의 이름을 정하고 주의사항을 알려주는 함수 정의하기
        QMessageBox.about(self, '♡ 주 의 사 항 ♡', '1. 이름은 네 글자 이하로 입력해 주세요!' + '\n' + '2. 밥은 입력한 만큼 퍼센티지로 반영됩니다!' + '\n' + '      ( ex. 30 g -> 30 % )') # 주의사항 메세지 창 생성
        name, ok = QInputDialog.getText(self, 'INPUT NAME', '♡✧。°₊·다마고치의 이름은‧₊°。✧♡') # 이름 입력 받는 창 생성
